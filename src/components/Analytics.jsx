...
const Analytics = () => {
  ...
  const monthlyData = Array.from({ length: 6 }, (_, i) => {
    ...
    const monthIncome = expenses.filter(exp => {
      const expenseDate = new Date(exp.date);
      return expenseDate.getMonth() === date.getMonth() &&
             expenseDate.getFullYear() === date.getFullYear() &&
             exp.type === 'income';
    ...
    return {
      ...
      income: monthIncome.reduce((sum, exp) => sum + exp.amount, 0)
    };
  }).reverse();
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="lg:hidden p-6 space-y-8">
        {/* Use your existing mobile content */}
      ...
      <div className="hidden lg:block p-8">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          >
            ...
            <p className="body-text-light">Deep insights into your spending patterns</p>
          </motion.div>
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-4 space-y-6">
              ...
              <motion.div
                ...
                className="glass-card rounded-futuristic p-6"
              >
                <h3 className="heading-3 mb-4">Budget Overview</h3>
              ...
              >
                ...
                <div className="space-y-3">
                  {/* Add any other quick stats here */}
                </div>
              </motion.div>
            </div>
          </div>
